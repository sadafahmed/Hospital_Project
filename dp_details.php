...
<div class="container">
  ...
  <li class="active"><a href="dp_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Department detail</a></li>
  <li ><a href="dp_form.php"><i class="glyphicon glyphicon-plus"></i> Add Department</a></li>
...
$query= "select *from department order by 1 desc LIMIT 10";

$run= mysqli_query($mysqli, $query);

while($row = mysqli_fetch_array($run)){
	$dname=$row[1];
	$dept_discription = $row[2];
...
<td><?php echo $dept_discription; ?></td>
</tr>
<?php } 
