          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <h3>General</h3>
              <ul class="nav side-menu">
				...
				<li><a><i class="fa fa-user-md"></i> &nbsp; Docoter Department<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
...
<div class="container">
  ...
  <li  class="active"><a href="app_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Appointment detail</a></li>
  <li><a href="app_form.php"><i class="glyphicon glyphicon-plus"></i> Add Appointment</a></li>
...
<table id="dataTable" class="table table-striped table-bordered table-hover" border="1" width="100%" cellspacing="0" cellpadding="5">
     ...
     <tbody>     
		<?php
		$sql = "SELECT appointment.*, doctor.dr_name, patient.pat_name
			FROM appointment 
			LEFT JOIN doctor ON doctor.dr_id = appointment.dr_id
			LEFT JOIN patient ON patient.pat_id = appointment.pat_id";
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="app_details.php">1</a></li>
