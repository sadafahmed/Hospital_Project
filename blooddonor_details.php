...
<div class="container">
  ...
  <li class="active"><a href="blooddonor_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Blooddonor detail</a></li>
...
$query= "select *from blood_donor order by 1 Asc LIMIT 10";
...
<td><?php echo $bg; ?></td>
<td><?php echo $ldd; ?></td>
<td><a href="veiwbldd_detail.php?id=".$row['dr_id']?.>Read More</a></td>
</tr>
<?php } 
