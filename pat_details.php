...
<div class="container">
   ...
   <li class="active"><a href="pat_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Patient detail</a></li>
  <li><a href="pat_form.php"><i class="glyphicon glyphicon-plus"></i> Add Patient</a></li>
...
$query= "select *from patient order by 1 Desc ";
...
while($row = mysqli_fetch_array($run)){
	...
	$bg = $row[9];
			...
			<td><?php echo $age; ?></td>
			<td><?php echo $bg; ?></td>
			<td><a href="veiwpat_detail.php?id=".$row['pat_id']?.>Read More</a></td>
			</tr>
			<?php } 
