...
<div class="container">
 ...
 <li  class="active"><a href="death_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Death details</a></li>
...
$query= "select *from death order by 1 desc LIMIT 10";
