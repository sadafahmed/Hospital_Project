...
<body class="nav-md">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-user-md"></i> &nbsp; Doctor <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
					...
					<li><a href="dr_details.php">Veiw Docotr</a></li>
 ...
 <ul class="nav nav-tabs">
  <li><a href="shedule_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Shedule Detail</a></li>
  <li class="active"><a href="shedule_form.php"><i class="glyphicon glyphicon-plus"></i> Add Shedule Detail</a></li>
...
.col-lg-12
 ...
 <h1>Add Shedule Detail</h1> <br>
      

<div class="main">

		  <form method="post" action="shedule_form.php">
           ...
           <input type="text" name="shd_day" class="form-control" placeholder="Shedule Day.."/><br>
            ...
            <div>
           <input type="text" name="start_time" class="form-control" placeholder="Start Time.." autofocus/><br>
            </div>
            <div>
			<input type="text" name="end_time" class="form-control" placeholder="End Time.." /><br>
            </div>
			<div>
	  <input type="submit" name="submit" value="Add New Shedule" class="btn-danger btn-lg" /><br>
            </div>
		...
		if(isset($_POST['submit'])){
			 ...
			 $shd_day= mysqli_real_escape_string($mysqli, $_POST['shd_day']);	
			 $start_time= mysqli_real_escape_string($mysqli, $_POST['start_time']);	
			 $end_time = mysqli_real_escape_string($mysqli, $_POST['end_time']);
																								  
	 
 
	 if($drId=='' or $shd_day=='' or $start_time=='' or $end_time==''){
	 
	 echo "<script>alert('Some Fields are empty')</script>";
	 exit();
 }

 $query ="INSERT INTO shedule (dr_id, shd_day, start_time, end_time) VALUES
				('$drId','$shd_day','$start_time','$end_time')";
 //echo $query; die;
 if(mysqli_query($mysqli, $query)){
	
	echo "<script>window.open('shedule_details.php','_self')</script>";	
		}
		else
		{
