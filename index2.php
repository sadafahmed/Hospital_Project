        ...
        <div class="nav_menu">
          <nav class="" role="navigation">
            <div class="nav toggle">
              <a id="menu_toggle"><i class="fa fa-bars">&nbsp;&nbsp;Nurse</i></a>
            </div>
        ...
        <div class="">
         ...
         <a href="pat_details.php">   <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats"style="height: 100px;">
                <center>
                         <i class="fa fa-user" style="font-size: 50px;padding-top: 10px;" ></i>
         ...
         <a href="room_details.php">    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
          ...
          <a href="blooddonor_details.php">   <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats"style="height: 100px;padding-top: 10px;">
                <center>
            ...
            <div class="col-md-12">
              <div class="x_panel">
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12" style="height: 120px;" >
                    <div>
                      <ul class="list-unstyled top_profiles scroll-view " style="height: 120px; border-radius: 5px; padding: 5px; color: red; ">
				  ...
				  <div class="col-md-4 col-sm-12 col-xs-12"style="float: right; padding-left: 40px" >
                    <div>
                      <div class="x_title">
                       ...
                       <h3 style="padding-left: 70px;">Noticeboard</h3>
...
<?php echo $desc; ?><br>
<b><p style= "float: right;">published on :</b><br> <?php echo $date;?></p><br><br>
