...
<body class="nav-md">
                ...
                <li><a><i class="fa fa-user-md"></i> &nbsp; Doctor <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
					...
					<li><a href="dr_details.php">Veiw Doctor</a></li>
					 <li><a href="Shedule_details.php">Docoter Shedule</a></li>
                  </ul>
                </li>
 ...
 <ul class="nav nav-tabs">
  ...
  <li><a href="dr_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Docter detail</a></li>
  <li class="active"><a href="dr_form.php"><i class="glyphicon glyphicon-plus"></i> Add docter</a></li>
...
<div class="main">
		...
		<div>
              <select name="dep_id" value="" class="form-control"><br>
			   <option name="dept_id" selected="selected">Select Department</option>
			    <?php
				...
				?>
			    <option value="<?php echo $row['dept_id']; ?>"><?php echo $row['dept_discription']; ?></option>
				<?php } ?>
              </select>
            </div><br>
			<div>
          ...
          <input type="text" class="form-control" name="contact" placeholder="Contact-no..."  /><br>
            ...
            <div>
	  <input type="submit" name="submit" value="Add New Doctor" class="btn-danger btn-lg "/><br>
            </div>
	...
	if(isset($_POST['submit'])){
			 ...
			 $user_qualiff = mysqli_real_escape_string($mysqli, $_POST['qualif']);
			 $user_speciall = mysqli_real_escape_string($mysqli, $_POST['special']);
			 $user_dept = mysqli_real_escape_string($mysqli, $_POST['dep_id']);
			 
			 $user_email= mysqli_real_escape_string($mysqli, $_POST['email']);
			 $user_passs= mysqli_real_escape_string($mysqli, $_POST['pass']);																			
 ...
 if(mysqli_query($mysqli, $query)){
	...
	echo "<script>window.open('dr_details.php','_self')</script>";	
		...
		{
		echo "<script>alert('Fields are required to fill');</script>";
