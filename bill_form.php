...
?> 
 ...
 <ul class="nav nav-tabs">
  <li><a href="bill_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Bill Detail</a></li>
  <li class="active"><a href="bill_form.php"><i class="glyphicon glyphicon-plus"></i> Add Bill Detail</a></li>
...
h2
{
 ...
 <h2>Add New Bill Record</h2>
      

<div class="main">

		    <form method="post" action="bill_form.php">
		...
		<div>          
			...
			<div>
			<input placeholder="Admit date and time"  class="form-control" type="text" onfocus="(this.type='date')" name="add_date"><br>
            </div>
			<div>
			<input placeholder="Discharge dateand time"  class="form-control"type=" text" onfocus="(this.type='date')" name="dis_date"><br>
            </div>
			<div>
            <input type="text" name="room_chrg" class="form-control" placeholder="Room Charges.."  /><br>
            </div>
			<div>
            <input type="text" name="ot" class="form-control" placeholder="O.T Charges.."  /><br>
            </div>
			<div>
            <input type="text" name="surgeon" class="form-control" placeholder="Surgeon Fees.."  /><br>
            </div>
			<div>
            <input type="text" name="assis" class="form-control" placeholder="Assistance Fees.."  /><br>
            </div>
			<div>
            <input type="text" name="anses" class="form-control" placeholder="Ansesthetist Charges.."  /><br>
            </div>
			<div>
            <input type="text" name="phys" class="form-control" placeholder="physician Charges.."  /><br>
            </div>
			<div>
            <input type="text" name="dressing" class="form-control" placeholder="Daily Dressing Charges.."  /><br>
            </div>
			<div>
			...
			<div>
            <input type="text" name="lab" class="form-control" placeholder="Lab Test Charges.."  /><br>
            </div>
			<div>
            <input type="text" name="ecg" class="form-control" placeholder="Ultrasound/E.C.G/Nebrlizer.."  /><br>
            </div>
			<div>
            <input type="text" name="totl" class="form-control" placeholder="Total amount..."  /><br>
            </div>
			
			<div>
			<input type="submit" name="submit" value="Generate Bill" class="btn-danger btn-lg" /><br>
            </div>
	...
	if(isset($_POST['submit'])){
	  ...
	  $dis_date= mysqli_real_escape_string($mysqli, $_POST['dis_date']);
	  $room_charge= mysqli_real_escape_string($mysqli, $_POST['room_chrg']);
	  $ot= mysqli_real_escape_string($mysqli, $_POST['ot']);
	  $surgeon= mysqli_real_escape_string($mysqli, $_POST['surgeon']);
	  $assis= mysqli_real_escape_string($mysqli, $_POST['assis']);
	  $anses= mysqli_real_escape_string($mysqli, $_POST['anses']);
	  $phys= mysqli_real_escape_string($mysqli, $_POST['phys']);
	  ...
	  $ecg = mysqli_real_escape_string($mysqli, $_POST['ecg']);      
	  $totl_amount = mysqli_real_escape_string($mysqli, $_POST['totl']);      
																							 
									// echo '<pre>'; print_r($_POST); die;													 
	 if( $user_name=='' or $age=='' or $gender=='' or $address=='' ){
	 
	 echo "<script>alert('Some Fields are empty')</script>";
	 exit();
 }

 $query ="insert into `bill` (reg_id, bill_name, bill_age, bill_sex, bill_occ, bill_address, 
