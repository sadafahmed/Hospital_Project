...
<div class="main">
		  ...
		  <input type="radio" name="gender" value="female"> Female
            ...
            <select name="bg" value="blood grp" class="form-control"><br>
			  <option select="selected" name="bg">Blood group</option>
		  ...
		  <div>
           ...
           <input type="text" name="contact_no" class="form-control" placeholder="Contact-no.."  /><br>
			   ...
			   <div>
	  <input type="submit" name="submit" value="Add New Blooddonor" class="btn-danger btn-lg" /><br>
            </div>
...
include('db.php');	
	...
	if(isset($_POST['submit'])){
	  ...
	  $user_dd= mysqli_real_escape_string($mysqli,$_POST['don_date']);
 ...
 $query ="INSERT into `blood_donor` (bd_name, bd_age, bd_gender, bd_blood_group, bd_date, bd_address ,bd_contact_no) VALUES
 ('$user_name','$user_age','$user_gender','$user_bg','$user_dd','$user_address','$user_contact_no')";
	 
	 //echo $query; die;
 if(mysqli_query($mysqli, $query)){
	
	echo "<script>window.open('blooddonor_details.php','_self')</script>";	
		}
		else
		{
