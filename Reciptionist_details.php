...
?>
   ...
   <li class="active"><a href="account_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Reciptionist detail</a></li>
  <li><a href="account_form.php"><i class="glyphicon glyphicon-plus"></i> Add Reciptionist</a></li>
