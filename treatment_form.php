...
include('db.php');	
	...
	if(isset($_POST['submit'])){
			 ...
			 $drId= mysqli_real_escape_string($mysqli, $_POST['dr_id']);	
			 $trt_dis= mysqli_real_escape_string($mysqli, $_POST['trt_dis']);	
			 $trt_date= mysqli_real_escape_string($mysqli, $_POST['trt_date']);	
			 $trt_disc = mysqli_real_escape_string($mysqli, $_POST['trt_disc']);
			 
			 
 
	 if($trt_dis=='' or $trt_date=='' or $trt_disc==''){
	 
	 echo "<script>alert('Some Fields are empty')</script>";
	 exit();
 }

 $query ="insert into treatment(pat_id, dr_id, treat_disease,treat_date,treat_desc) VALUES
 ('$patId', '$drId', '$trt_dis','$trt_date','$trt_disc')";
 if (false === $query) {
    echo mysqli_error();
}
 if(mysqli_query($mysqli, $query)){
	
	echo "<script>window.open('treatment_details.php','_self')</script>";	
		}
		else
		{
...
?>  
 ...
 <ul class="nav nav-tabs">
  <li><a href="treatment_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Treatment Detail</a></li>
  <li class="active"><a href="treatment_form.php"><i class="glyphicon glyphicon-plus"></i> Add Treatment Detail</a></li>
...
h2
{
 ...
 <h2>Add Treatment Details</h2> <br>
      

<div class="main">

		  <form method="post" action="treatment_form.php">
		  <div>
			...
			<div>
			<input placeholder="Treatment date.."  class="form-control" type="text" onfocus="(this.type='date')" name="trt_date"><br>
            </div>
			 <div>
           <input type="text" name="trt_dis" class="form-control" placeholder="Treatment disease.." autofocus/><br>
            </div>
            <div>
           <input type="text" name="trt_disc" class="form-control" placeholder="Treatment description .." /><br>
            </div>
			<div>
	  <input type="submit" name="submit" value="Add New Treatment Record" class="btn-info btn-lg" /><br>
            </div>
