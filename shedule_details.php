            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-user-md"></i> &nbsp; Doctor <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="dr_form.php">Add Docoter </a></li>
...
<div class="container">
  ...
  <li class="active"><a href="shedule_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> See Shedule Detail</a></li>
  <li><a href="shedule_form.php"><i class="glyphicon glyphicon-plus"></i> Add Shedule Detail</a></li>
...
include 'db.php';
 ...
 $query = "SELECT shedule.*, doctor.dr_name
			FROM shedule 
			LEFT JOIN doctor ON doctor.dr_id = shedule.dr_id";
			$result = mysqli_query ($mysqli, $query);
			while ($row = mysqli_fetch_array ($result)) {
		?>
		<tr>
		<td><?php echo $row['dr_name']; ?></td>
		<td><?php echo $row['shd_day']; ?></td>
        <td><?php echo $row['start_time']; ?></td>
        <td><?php echo $row['end_time']; ?></td></tr>
		<?php } ?>
