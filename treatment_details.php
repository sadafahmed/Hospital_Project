...
<div class="container">
  ...
  <li class="active"><a href="treatment_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Treatment Detail</a></li>
  <li><a href="treatment_form.php"><i class="glyphicon glyphicon-plus"></i> Add Treatment Detail</a></li>
...
<table id="dataTable" class="table table-striped table-bordered table-hover" border="1" width="100%" cellspacing="0" cellpadding="5">
 ...
 $query = "SELECT treatment.*,  patient.pat_name, doctor.dr_name
			FROM treatment 
			LEFT JOIN patient ON patient.pat_id = treatment.pat_id
			LEFT JOIN doctor ON doctor.dr_id = treatment.dr_id";
