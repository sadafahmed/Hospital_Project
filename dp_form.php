...
?>  
 ...
 <ul class="nav nav-tabs">
  <li><a href="dp_details.php"><i class="glyphicon glyphicon-menu-hamburger"></i> Department detail</a></li>
  <li class="active"><a href="dp_form.php"><i class="glyphicon glyphicon-plus"></i> Add Department</a></li>
...
include('db.php');	
	...
	if(isset($_POST['submit'])){
	  ...
	  $user_dept_discription= $_POST['dept_discription'];
	 
	  // echo '<pre>'; print_r($_POST); die;
	  	
 
	 if($user_dname=='' or $user_dept_discription==""){
	 
	 echo "<script>alert('Some Fields are empty')</script>";
	 exit();
 }

 $query ="insert into department(doc_name, dept_discription) VALUES
 ('$user_dname','$user_dept_discription')";
 //echo $query; die;
 if(mysqli_query($mysqli, $query)){
	
	echo "<script>window.open('dp_details.php','_self')</script>";	
		}
		else
		{
