...
<div class="main">
		 ...
		 <form  method="post" action="birth_form.php">
			 
		 <div>
          <input type="text" class="form-control" name="s_no" placeholder="S.no..."  /><br>
            </div>
			 <div>
          <input placeholder="Date of reg..."  class="form-control"type="text" onfocus="(this.type='date')" name="date_of_reg"><br>
            </div>
            <div>
           <input type="text" class="form-control" name="name" placeholder="Name of child..."style="text-transform: capitalize"; /><br>
            </div>
			 <div>
           <input type="text" class="form-control" name="fname" placeholder="Father Name..." style="text-transform: capitalize"; /><br>
            </div>
					<div>
		  ...
		  <div>
          <input placeholder="Date of birth..."  class="form-control"type="text" onfocus="(this.type='date')" name="dob"><br>
            </div>

			<div>
           <input type="text" class="form-control" name="address" placeholder="Address of father..." style="text-transform: capitalize"; /><br>
            </div>
		
					  <div>
          <input type="text" class="form-control" name="occuption" placeholder="Occuption of father..." style="text-transform: capitalize"; /><br>
            </div>
			<div>
          <input type="text" class="form-control" name="religion" placeholder="Religion of father..." style="text-transform: capitalize"; /><br>
            </div>
		    <div>
          <input type="text" class="form-control" name="reporter" placeholder="Name of reporter..." style="text-transform: capitalize"; /><br>
            </div>
          <div>
          <input type="text" class="form-control" name="conducted" placeholder="Name of doctor/Dai/Mid-wife who conducted delivery..." style="text-transform: capitalize"; /><br>
            </div>
				<div>
          <input type="text" class="form-control" name="remarks" placeholder="Remarks..." style="text-transform: capitalize"; /><br>
            </div>
			<br><br>
            <div>
	  <input type="submit" name="submit" class="btn btn-lg btn-danger " value="Generate birth report" al /><br>
            </div>
...
include('db.php');	
	...
	if(isset($_POST['submit'])){
	  ...
	  $user_s_no= $_POST['s_no'];	
	  $user_date_of_reg= $_POST['date_of_reg'];	
	  $user_name= $_POST['name'];
	  $user_fname= $_POST['fname'];
	  $user_gender= $_POST['gender'];
      $user_dob= $_POST['dob'];
	  $user_address= $_POST['address'];
	  $user_occuption= $_POST['occuption'];
	  $user_religion= $_POST['religion'];
	  $user_reporter= $_POST['reporter'];
	  $user_conducted= $_POST['conducted'];
